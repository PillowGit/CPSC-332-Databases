...
function ProfessorInfo({ setTable }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className=" border-x-slate-700 border-b-2 min-w-96 text-2xl font-bold mt-8 mb-4">Get Professor's Classes with SSN</div>
      <div className="flex flex-row justify-center items-center min-h-20 mb-8 min-w-4">
        <div className="flex flex-col justify-around items-center min-h-20 mx-8">
          ...
          <input type="text" value={ssn} onChange={handleSsnChange} className="text-center text-wrap border-stone-900 border-2 bg-stone-800"/>
        </div>
